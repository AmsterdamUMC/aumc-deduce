...
EXPECTED_RELEASE_BRANCH_AUMC_DEDUCE_CONF="release-$VER_MAJOR.$VER_MINOR.$VER_PATCH"
EXPECTED_RELEASE_BRANCH_AUMC_DEDUCE_SUPPLEMENTAL="release-$VER_MAJOR.$VER_MINOR.$VER_PATCH"
